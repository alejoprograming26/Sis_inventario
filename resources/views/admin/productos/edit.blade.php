...
@section('content_header')
    <nav aria-label="breadcrumb" style="font-size: 18pt">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Actualizacion de un Producto</li>
        </ol>
    </nav>
    <hr>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" id="unidad_medida" name="unidad_medida"
                                                    ...
                                                    <option value="kilogramo"
                                                        {{ $producto->unidad_medida == 'kilogramo' ? 'selected' : '' }}>
                                                        Kilogramo</option>
                                                    <option value="litro"
                                                        {{ $producto->unidad_medida == 'litro' ? 'selected' : '' }}>Litro
                                                    </option>
                                                    <option value="Paquete"
                                                        {{ $producto->unidad_medida == 'Paquete' ? 'selected' : '' }}>
                                                        Paquete
                                                    </option>
                                                </select>
                                            </div>
