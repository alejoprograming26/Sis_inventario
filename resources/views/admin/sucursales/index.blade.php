        ...
        <div class="col-md-12">
            <div class="card card-outline card-orange">
                <div class="card-header">
                    <h1 class="card-title"><b>Sucursales Registradas</b></h1>
                    <div class="card-tools">
                        <a href="{{ url('admin/sucursales/create') }}" class="btn btn-primary btn-sm"><i
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            <a href="{{ url('admin/sucursales/' . $sucursal->id) }}" type="button"
                                                class="btn btn-info">
                                            ...
                                            <form action="{{ url('/admin/sucursales/' . $sucursal->id) }}"
                                                id="miFormulario{{ $sucursal->id }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                    onclick="event.preventDefault(); eliminarFormacion('{{ $sucursal->id }}');">
