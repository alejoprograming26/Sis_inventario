        ...
        <div class="col-md-8">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h1 class="card-title"><b>Ver Datos de la Sucursal</b></h1>
                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ $sucursal->telefono }}" class="form-control"
                                            id="telefono" name="telefono" placeholder="Ingrese el telefono de la Sucursal"
                                            readonly>
                                    </div>
                                    @error('telefono')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="estado" name="estado" disabled>
                                            ...
                                            <option value="1" {{ $sucursal->estado == '1' ? 'selected' : '' }}>Activo
                                            </option>
                                            <option value="0" {{ $sucursal->estado == '0' ? 'selected' : '' }}>
                                                Inactivo
                                            </option>
                                        </select>
                                        @error('estado')
